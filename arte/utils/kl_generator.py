...
class KLGenerator(object):
    ...
    def generateFromBase(self, inBase):
        ...
        if nmodes != self._nmodes:
            raise ValueError("The number of modes in the base is different from the number of modes in the covariance matrix")
        ...
        self._klBase = np.rollaxis(np.ma.masked_array([self.getKL(n) 
