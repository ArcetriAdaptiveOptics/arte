...
class BaseAnalyzerTest(unittest.TestCase):
    ...
    def test_get_cache(self):
        ee1 = DummyAnalyzer.get('20240404_024500')
        ee2 = DummyAnalyzer.get('20240404_024500')
        assert id(ee1) == id(ee2)

    def test_recalc(self):
        _ = DummyAnalyzer.get('20240404_024500', recalc=True)

    def test_date_in_seconds(self):
        seconds = DummyAnalyzer.get('20240404_024500').date_in_seconds()
        assert seconds == 1712198700.0

    def test_info(self):
        info = DummyAnalyzer.get('20240404_024500').info()
