...
class Cn2ProfileTest(unittest.TestCase):
    ...
    def testSingleLayer(self):
        ...
        self.assertEqual([100], pr.layers_distance())
    ...
    def testSetAndGetAirmassAndZenithAngle(self):
        ...
        self.assertAlmostEqual(0, pr.zenith_angle())
        self.assertAlmostEqual(1, pr.airmass())
        pr.set_zenith_angle(60)
        self.assertAlmostEqual(60, pr.zenith_angle())
    ...
    def testBuildFromFractionalJ(self):
        ...
        pr= Cn2Profile.from_fractional_j(0.13, [0.1, 0.9], 30, 100, 10, 0.3)
    ...
    def testEsoProfiles(self):
        ...
        self.assertAlmostEqual(5.786, pr.wind_speed()[0], delta=0.01)
